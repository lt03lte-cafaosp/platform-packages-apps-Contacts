 ...
 */
public class DialpadDialerKeyListener extends NumberKeyListener
{
    @Override
    ...
    public static DialpadDialerKeyListener getInstance() {
        if (sInstance != null)
            return sInstance;

        sInstance = new DialpadDialerKeyListener();
        return sInstance;
    }
    ...
    private static DialpadDialerKeyListener sInstance;
}
