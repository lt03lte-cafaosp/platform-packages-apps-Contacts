...
//    }
    ...
    private void getIPCallIntent(CharSequence digits, int sub) {
        ...
        if(sub == 0) {
                ipnumber = Settings.System.getString(getActivity().getContentResolver(), "ipcall_prefix_sub1");
                Log.d(TAG," sub_0  ip number is " + ipnumber);
        }
        else if(sub == 1) {
                ipnumber = Settings.System.getString(getActivity().getContentResolver(), "ipcall_prefix_sub2");
