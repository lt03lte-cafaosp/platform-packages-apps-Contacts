...
public abstract class PhotoSelectionHandler implements OnClickListener {
            ...
            switch (requestCode) {
                ...
                case REQUEST_CODE_PHOTO_PICKED_WITH_DATA: {
                    ...
                    if (null == bitmap) {
                        ...
                        if (uri != null) {
                            goToCropImage(uri,listener.getCurrentPhotoFile(),
    ...
    private boolean isValidFile(Uri fileUri) {
        ...
        if (suffix.equals("jpg") || suffix.equals("jpeg")
                ...
                || suffix.equals("bmp") || fileName.startsWith("/contacts")) {
            return true;
        }
        Toast.makeText(mContext, R.string.fail_reason_not_supported,
    ...
    private Uri parseFileToUri(Uri filename){
        ...
        try {
            imageCursor = mContext.getContentResolver().query(
                    ...
                    new String[]{filename.getPath()}, null);
