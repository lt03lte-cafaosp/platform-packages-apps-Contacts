...
public final class CallLogQuery {
    ...
    public static final String[] _PROJECTION = new String[] {
            ...
            Calls.IS_READ,                   // 16
            Calls.SUBSCRIPTION,              // 17//xiaohong add 
            Calls.DURATION_TYPE,             // 18//xiaohong add 
    };
    ...
    public static final int SUBSCRIPTION = 17;//xiaohong add
   public static final int DURATION_TYPE = 18;//xiaohong add 
    /** The index of the synthetic "section" column in the extended projection. */
    public static final int SECTION = 19;//xiaohong modify 
